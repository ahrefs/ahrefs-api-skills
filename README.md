...
Then ask Claude Code to use the Ahrefs API — it will know the SDK patterns, all 105 methods, error handling, and filter syntax.
...
- **All 105 API methods** — Site Explorer, Keywords Explorer, Management, Rank Tracker, Site Audit, Brand Radar, SERP Overview, Batch Analysis, Web Analytics, Public, Subscription Info
