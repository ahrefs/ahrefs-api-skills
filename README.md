...
Then ask Claude Code to use the Ahrefs API — it will know the SDK patterns, all 86 methods, error handling, and filter syntax.
...
- **All 86 API methods** — Site Explorer, Keywords Explorer, Rank Tracker, Site Audit, Brand Radar, SERP Overview, Batch Analysis, Web Analytics
